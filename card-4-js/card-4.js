...
//card identify from the first 2 digits.
  if (
    ...
    cardTypeImage_card_4.innerHTML =
      '<img class="card-4-mobile-image" src="./card-4-images/americanexpress.png" alt="americanexpress" style="display:initial;">';
  }else if (cardNumber.startsWith("6")) {
    cardTypescard4.style.animation = "none";
    cardTypescard4.style.backgroundImage = "none";
    cardTypeImage_card_4.innerHTML =
      '<img class="card-4-mobile-image" src="./card-4-images/discover.png" alt="americanexpress" style="display:initial;">';
  } else if (
    cardNumber.startsWith("51") ||
    cardNumber.startsWith("52") ||
    cardNumber.startsWith("53") ||
    ...
    cardTypescard4.style.backgroundImage = "none";
    cardTypeImage_card_4.innerHTML =
      '<img class="card-4-mobile-image " src="./card-4-images/marstercard.png" alt="marstercard" style="display:initial;">';
  } else if (cardNumber.startsWith("4")) {
    cardTypescard4.style.animation = "none";
    cardTypescard4.style.backgroundImage = "none";
    cardTypeImage_card_4.innerHTML =
      '<img class="card-4-mobile-image " src="./card-4-images/Visa.png" alt="visa" style="display:inline-block;">';
  }
});
